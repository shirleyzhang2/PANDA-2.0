...
void Spreadsheet::clear(int rows, int cols)
{
    setRowCount(0);
    setColumnCount(0);
    setRowCount(rows);
...
//    setHorizontalHeaderLabels( horizHeader );
...
//        setCellWidget(j, checkbox_loc, w); //Place the widget in the table
//    }
}
...
void Spreadsheet::paste()
{
    ...
    // Add -1 to account for empty row when pasting from excel
